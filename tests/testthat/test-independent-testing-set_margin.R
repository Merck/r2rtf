test_that("margin type: csr, portrait", {
  expect_equal(set_margin("csr", "portrait"),
...
test_that("margin type: wma, portrait", {
  expect_equal(set_margin("wma", "portrait"),
