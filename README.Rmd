...
<details>
```{r, echo = FALSE}
knitr::include_graphics("articles/fig/ex-tbl.png", error = FALSE)
```
<\details>
...
<details>
```{r, echo = FALSE}
knitr::include_graphics("articles/fig/efficacy_example.png", error = FALSE)
```
<\details>
...
<details>
```{r, echo = FALSE}
knitr::include_graphics("articles/fig/ae_example.png", error = FALSE)
```
<\details>
