...
<details>
```{r, echo = FALSE}
knitr::include_graphics("https://merck.github.io/r2rtf/articles/fig/ex-tbl.png", error = FALSE)
```
</details>
...
<details>
```{r, echo = FALSE}
knitr::include_graphics("https://merck.github.io/r2rtf/articles/fig/efficacy_example.png", error = FALSE)
```
</details>
...
<details>
```{r, echo = FALSE}
knitr::include_graphics("https://merck.github.io/r2rtf/articles/fig/ae_example.png", error = FALSE)
```
</details>
