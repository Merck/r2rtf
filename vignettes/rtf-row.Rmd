...
`r2rtf:::format_fixed_ties_away()` then applies ties-away-from-zero rounding and retains
...
```{r}
db <- iris %>% mutate(Sepal.Length = r2rtf:::format_fixed_ties_away(Sepal.Length * 2, 1))
